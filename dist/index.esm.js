...
var Icon$11 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React.createElement("image", { width: "256", height: "256", href: "/image/logo.png" })));
};
...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 94 94" }, props),
        React.createElement("svg", { width: "94", height: "94", viewBox: "0 0 94 94", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
            React.createElement("path", { stroke: "#24c7d6", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M92 47C92 22.147 71.853 2 47 2S2 22.147 2 47s20.147 45 45 45" }))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#3C5880", textDisabled: "#BDC2C4", textSubtle: "#3A5DB1", borderColor: "#E9EAEB", gradients: {
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "#", target: "_blank" },
        ...
        React.createElement(Text, { color: "textSubtle" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React.createElement(Text, { fontSize: "20px", style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
